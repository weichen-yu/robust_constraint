...
class InfoLoss(BaseLoss):
    ...
    def forward(self, embeddings, labels):
        ...
        # tri_loss = mask_tri * F.relu(dist_diff + self.margin)
        # tri_loss = tri_loss.transpose(1,0)
        
        # tri_loss, loss_num = self.AvgNonZeroReducer(tri_loss)
        # loss_avg = tri_loss.mean() + info_loss.mean()
